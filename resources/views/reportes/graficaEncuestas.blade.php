...
<div class="container mt-4">
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Resumen de Encuestas Contestadas</h5>
        </div>
        <div class="card-body">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title" id="graficaModalLabel">Resumen de Encuestas Contestadas</h6>
            ...
            <div class="modal-body">
                ...
                <div class="mb-4">
                    <canvas id="resumenEncuestasChart"></canvas>
                </div>
