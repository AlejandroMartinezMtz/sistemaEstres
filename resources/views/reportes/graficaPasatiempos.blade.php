    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h5>Gráfica de Pasatiempos Más Seleccionados (Del {{ $startDate }} al {{ $endDate }})</h5>
            </div>
            <div class="card-body">
                <h6><strong>Total de Pasatiempos seleccionados:</strong> {{ $topPasatiempos->sum('total') }}</h6>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="graficaModalLabel">Gráfica de top 5 Pasatiempos contra el Estrés</h6>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <!-- Contenedor de la gráfica -->
                    <div class="contenidoGrafica">
                        <h6><strong>Total de votos:</strong> {{ $topPasatiempos->sum('total') }}</h6>
                    </div>

                    <!-- Canvas para la gráfica -->
                    <canvas id="pasatiemposChart"></canvas>
