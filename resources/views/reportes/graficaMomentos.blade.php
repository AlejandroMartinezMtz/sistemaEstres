    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header">
                <h5>Gráfica de Aplicación de cuestionario en momentos (Del {{ $startDate }} al {{ $endDate }})</h5>
            </div>
            <div class="card-body">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="graficaModalLabel">Gráfica de Analisis de comparación</h6>
                ...
                <div class="modal-body">
                    ...
                    <canvas id="cuestionariosChart"></canvas>
